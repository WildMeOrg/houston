...
def test_create_autogenerated_name(
    ...
    error = 'Changing next_value currently forbidden'
...
def test_create_individual(
    ...
    assert not AutogeneratedName.integrity_find_invalid_name_contexts()
    assert not AutogeneratedName.integrity_find_invalid_references()
    assert not AutogeneratedName.integrity_find_invalid_individuals()

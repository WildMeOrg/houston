...
class Annotations(Resource):
    ...
    def get(self, args):
        ...
        List of Annotation.
        """
        return CodexAnnotation.query_search(args=args)
...
class AnnotationElasticsearch(Resource):
    ...
    def get(self, args):
        search = {}
        args['total'] = True
        return CodexAnnotation.elasticsearch(search, **args)
...
@api.resolve_object_by_model(CodexAnnotation, 'annotation')

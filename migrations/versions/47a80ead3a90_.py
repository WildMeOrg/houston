...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['mission_guid'],
            ['mission.guid'],
            name=op.f('fk_mission_user_assignment_mission_guid_mission'),
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name=op.f('fk_mission_user_assignment_user_guid_user'),
        ),
        sa.PrimaryKeyConstraint(
            'mission_guid', 'user_guid', name=op.f('pk_mission_user_assignment')
        ),
    )
    with op.batch_alter_table('mission_user_assignment', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_mission_user_assignment_created'), ['created'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_mission_user_assignment_updated'), ['updated'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['mission_guid'], ['mission.guid'], name=op.f('fk_task_mission_guid_mission')
        ),
        sa.ForeignKeyConstraint(
            ['owner_guid'], ['user.guid'], name=op.f('fk_task_owner_guid_user')
        ),
    ...
    with op.batch_alter_table('task', schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f('ix_task_mission_guid'), ['mission_guid'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_task_owner_guid'), ['owner_guid'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['asset_guid'], ['asset.guid'], name=op.f('fk_asset_tags_asset_guid_asset')
        ),
        sa.ForeignKeyConstraint(
            ['tag_guid'], ['keyword.guid'], name=op.f('fk_asset_tags_tag_guid_keyword')
        ),
    ...
    with op.batch_alter_table('asset_tags', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_asset_tags_created'), ['created'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_asset_tags_updated'), ['updated'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['asset_guid'],
            ['asset.guid'],
            name=op.f('fk_mission_asset_participation_asset_guid_asset'),
        ),
        sa.ForeignKeyConstraint(
            ['mission_guid'],
            ['mission.guid'],
            name=op.f('fk_mission_asset_participation_mission_guid_mission'),
        ),
        sa.PrimaryKeyConstraint(
            'mission_guid', 'asset_guid', name=op.f('pk_mission_asset_participation')
        ),
    )
    with op.batch_alter_table('mission_asset_participation', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_mission_asset_participation_created'),
            ['created'],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f('ix_mission_asset_participation_updated'),
            ['updated'],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['asset_guid'],
            ['asset.guid'],
            name=op.f('fk_task_asset_participation_asset_guid_asset'),
        ),
        sa.ForeignKeyConstraint(
            ['task_guid'],
            ['task.guid'],
            name=op.f('fk_task_asset_participation_task_guid_task'),
        ),
        sa.PrimaryKeyConstraint(
            'task_guid', 'asset_guid', name=op.f('pk_task_asset_participation')
        ),
    )
    with op.batch_alter_table('task_asset_participation', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_task_asset_participation_created'), ['created'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_task_asset_participation_updated'), ['updated'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['task_guid'],
            ['task.guid'],
            name=op.f('fk_task_user_assignment_task_guid_task'),
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name=op.f('fk_task_user_assignment_user_guid_user'),
        ),
        sa.PrimaryKeyConstraint(
            'task_guid', 'user_guid', name=op.f('pk_task_user_assignment')
        ),
    )
    with op.batch_alter_table('task_user_assignment', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_task_user_assignment_created'), ['created'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_task_user_assignment_updated'), ['updated'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['annotation_guid'],
            ['annotation.guid'],
            name=op.f('fk_task_annotation_participation_annotation_guid_annotation'),
        ),
        sa.ForeignKeyConstraint(
            ['task_guid'],
            ['task.guid'],
            name=op.f('fk_task_annotation_participation_task_guid_task'),
        ),
        sa.PrimaryKeyConstraint(
            'task_guid', 'annotation_guid', name=op.f('pk_task_annotation_participation')
        ),
    )
    with op.batch_alter_table('task_annotation_participation', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_task_annotation_participation_created'),
            ['created'],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f('ix_task_annotation_participation_updated'),
            ['updated'],
            unique=False,
        )
    ...
    with op.batch_alter_table('annotation', schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f('ix_annotation_contributor_guid'),
            ['contributor_guid'],
            unique=False,
        )
        batch_op.create_foreign_key(
            batch_op.f('fk_annotation_contributor_guid_user'),
            'user',
            ['contributor_guid'],
            ['guid'],
        )
    ...
    with op.batch_alter_table('asset', schema=None) as batch_op:
        batch_op.add_column(
            sa.Column('line_segments', app.extensions.JSON(), nullable=True)
        )
        batch_op.add_column(
            sa.Column('classifications', app.extensions.JSON(), nullable=True)
        )
...
def downgrade():
    ...
    with op.batch_alter_table('annotation', schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f('fk_annotation_contributor_guid_user'), type_='foreignkey'
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['mission_guid'],
            ['mission.guid'],
            name='fk_mission_user_membership_enrollment_mission_guid_mission',
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name='fk_mission_user_membership_enrollment_user_guid_user',
        ),
        sa.PrimaryKeyConstraint(
            'mission_guid', 'user_guid', name='pk_mission_user_membership_enrollment'
        ),
    )
    with op.batch_alter_table(
        'mission_user_membership_enrollment', schema=None
        ...
        batch_op.create_index(
            'ix_mission_user_membership_enrollment_updated', ['updated'], unique=False
        )
        batch_op.create_index(
            'ix_mission_user_membership_enrollment_created', ['created'], unique=False
        )

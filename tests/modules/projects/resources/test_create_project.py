...
def test_create_and_delete_project(flask_app_client, admin_user, researcher_user):
    ...
    assert read_project.owner == researcher_user

    # Try reading it back
    with flask_app_client.login(researcher_user, auth_scopes=('projects:read',)):

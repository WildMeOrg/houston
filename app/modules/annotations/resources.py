...
from .models import Annotation, CodexAnnotation, ScoutAnnotation
...
class Annotations(Resource):
    ...
    def post(self, args):
        ...
        elif isinstance(asset.git_store, Mission):
            if 'task_guid' not in args:
        ...
        with context:
            # Manually created annots are not autogenerated
            args['contributor_guid'] = current_user.guid
            args['autogenerated'] = False
            if isinstance(asset.git_store, AssetGroup):
                annotation = CodexAnnotation(**args)
            else:
                annotation = ScoutAnnotation(**args)

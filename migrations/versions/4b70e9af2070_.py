...
def upgrade():
    ...
    with op.batch_alter_table('name_auto_gen', schema=None) as batch_op:
        batch_op.drop_index('ix_name_auto_gen_created')
        batch_op.drop_index('ix_name_auto_gen_indexed')
        batch_op.drop_index('ix_name_auto_gen_updated')

    op.drop_table('name_auto_gen')
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column('indexed', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
        ...
        sa.Column('integer', sa.INTEGER(), autoincrement=False, nullable=False),
        sa.PrimaryKeyConstraint('guid', 'integer', name='pk_name_auto_gen'),
    )
    with op.batch_alter_table('name_auto_gen', schema=None) as batch_op:
        batch_op.create_index('ix_name_auto_gen_updated', ['updated'], unique=False)
        batch_op.create_index('ix_name_auto_gen_indexed', ['indexed'], unique=False)
        batch_op.create_index('ix_name_auto_gen_created', ['created'], unique=False)

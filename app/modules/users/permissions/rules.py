...
if is_module_enabled('missions'):
    ...
    OBJECT_USER_METHOD_MAP = {
        ...
        ('ScoutAnnotation', AccessOperation.READ): ['user_is_owner'],
        ('ScoutAnnotation', AccessOperation.WRITE): ['user_is_owner'],
        ('ScoutAnnotation', AccessOperation.DELETE): ['user_is_owner'],
    ...
    MODULE_USER_MAP = {
        ...
        ('CodexAnnotation', AccessOperation.READ): ['is_researcher'],
        ('CodexAnnotation', AccessOperation.WRITE): ['is_researcher'],
    ...
    OBJECT_USER_METHOD_MAP = {
        ...
        ('CodexAnnotation', AccessOperation.READ): ['user_is_owner'],
        ('CodexAnnotation', AccessOperation.WRITE): ['user_is_owner'],
        ('CodexAnnotation', AccessOperation.DELETE): ['user_is_owner'],

...
def test_custom_fields_on_sighting(
    ...
    encounters = [
        {
            ...
            'createdHouston': encounter.created.isoformat(),
            'updatedHouston': encounter.updated.isoformat(),
            'owner': {
    ...
    assert full_sighting.json == {
        ...
        'createdHouston': sighting.created.isoformat(),
        'updatedHouston': sighting.updated.isoformat(),
        'assets': assets,

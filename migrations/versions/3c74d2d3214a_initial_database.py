...
def upgrade():
    ...
    with op.batch_alter_table('file_upload', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_file_upload_mime_type'), ['mime_type'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['file_upload_guid'],
            ['file_upload.guid'],
            name=op.f('fk_site_setting_file_upload_guid_file_upload'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ['file_upload.guid'],
            name=op.f('fk_user_profile_fileupload_guid_file_upload'),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['owner_guid'], ['user.guid'], name=op.f('fk_asset_group_owner_guid_user')
        ),
    ...
    with op.batch_alter_table('asset_group', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_asset_group_commit_houston_api_version'),
            ['commit_houston_api_version'],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f('ix_asset_group_commit_mime_whitelist_guid'),
            ['commit_mime_whitelist_guid'],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f('ix_asset_group_major_type'), ['major_type'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_asset_group_owner_guid'), ['owner_guid'], unique=False
        )
    ...
    op.create_table(
        'collaboration_user_associations',
        sa.Column('created', sa.DateTime(), nullable=False),
        sa.Column('updated', sa.DateTime(), nullable=False),
        sa.Column('viewed', sa.DateTime(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            ['collaboration.guid'],
            name=op.f(
                'fk_collaboration_user_associations_collaboration_guid_collaboration'
            ),
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name=op.f('fk_collaboration_user_associations_user_guid_user'),
        ),
        sa.PrimaryKeyConstraint(
            'collaboration_guid',
            'user_guid',
            name=op.f('pk_collaboration_user_associations'),
        ),
    )
    op.create_table(
        'encounter',
        ...
        sa.ForeignKeyConstraint(
            ['individual_guid'],
            ['individual.guid'],
            name=op.f('fk_encounter_individual_guid_individual'),
        ),
        sa.ForeignKeyConstraint(
            ['owner_guid'], ['user.guid'], name=op.f('fk_encounter_owner_guid_user')
        ),
        sa.ForeignKeyConstraint(
            ['sighting_guid'],
            ['sighting.guid'],
            name=op.f('fk_encounter_sighting_guid_sighting'),
        ),
        sa.ForeignKeyConstraint(
            ['submitter_guid'],
            ['user.guid'],
            name=op.f('fk_encounter_submitter_guid_user'),
        ),
        sa.PrimaryKeyConstraint('guid', name=op.f('pk_encounter')),
    )
    with op.batch_alter_table('encounter', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_encounter_individual_guid'), ['individual_guid'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_encounter_owner_guid'), ['owner_guid'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_encounter_sighting_guid'), ['sighting_guid'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_encounter_submitter_guid'), ['submitter_guid'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['recipient_guid'],
            ['user.guid'],
            name=op.f('fk_notification_recipient_guid_user'),
        ),
        sa.PrimaryKeyConstraint('guid', name=op.f('pk_notification')),
    )
    with op.batch_alter_table('notification', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_notification_recipient_guid'), ['recipient_guid'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['owner_guid'], ['user.guid'], name=op.f('fk_organization_owner_guid_user')
        ),
        sa.PrimaryKeyConstraint('guid', name=op.f('pk_organization')),
    )
    with op.batch_alter_table('organization', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_organization_owner_guid'), ['owner_guid'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column('owner_guid', app.extensions.GUID(), nullable=False),
        sa.ForeignKeyConstraint(
            ['owner_guid'], ['user.guid'], name=op.f('fk_project_owner_guid_user')
        ),
        sa.PrimaryKeyConstraint('guid', name=op.f('pk_project')),
    )
    with op.batch_alter_table('project', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_project_owner_guid'), ['owner_guid'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['asset_group_guid'],
            ['asset_group.guid'],
            name=op.f('fk_asset_asset_group_guid_asset_group'),
            ondelete='CASCADE',
        ),
    ...
    with op.batch_alter_table('asset', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_asset_asset_group_guid'), ['asset_group_guid'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_asset_extension'), ['extension'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_asset_mime_type'), ['mime_type'], unique=False
        )
    ...
    op.create_table(
        'organization_user_membership_enrollment',
        sa.Column('created', sa.DateTime(), nullable=False),
        sa.Column('updated', sa.DateTime(), nullable=False),
        sa.Column('viewed', sa.DateTime(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            ['organization.guid'],
            name=op.f(
                'fk_organization_user_membership_enrollment_organization_guid_organization'
            ),
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name=op.f('fk_organization_user_membership_enrollment_user_guid_user'),
        ),
        sa.PrimaryKeyConstraint(
            'organization_guid',
            'user_guid',
            name=op.f('pk_organization_user_membership_enrollment'),
        ),
    )
    op.create_table(
        'organization_user_moderator_enrollment',
        sa.Column('created', sa.DateTime(), nullable=False),
        sa.Column('updated', sa.DateTime(), nullable=False),
        sa.Column('viewed', sa.DateTime(), nullable=False),
        sa.Column('organization_guid', app.extensions.GUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            ['organization.guid'],
            name=op.f(
                'fk_organization_user_moderator_enrollment_organization_guid_organization'
            ),
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name=op.f('fk_organization_user_moderator_enrollment_user_guid_user'),
        ),
        sa.PrimaryKeyConstraint(
            'organization_guid',
            'user_guid',
            name=op.f('pk_organization_user_moderator_enrollment'),
        ),
    )
    op.create_table(
        'project_encounter',
        ...
        sa.ForeignKeyConstraint(
            ['encounter_guid'],
            ['encounter.guid'],
            name=op.f('fk_project_encounter_encounter_guid_encounter'),
        ),
        sa.ForeignKeyConstraint(
            ['project_guid'],
            ['project.guid'],
            name=op.f('fk_project_encounter_project_guid_project'),
        ),
        sa.PrimaryKeyConstraint(
            'project_guid', 'encounter_guid', name=op.f('pk_project_encounter')
        ),
    )
    op.create_table(
        'project_user_membership_enrollment',
        sa.Column('created', sa.DateTime(), nullable=False),
        sa.Column('updated', sa.DateTime(), nullable=False),
        sa.Column('viewed', sa.DateTime(), nullable=False),
        sa.Column('project_guid', app.extensions.GUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ['project_guid'],
            ['project.guid'],
            name=op.f('fk_project_user_membership_enrollment_project_guid_project'),
        ),
        sa.ForeignKeyConstraint(
            ['user_guid'],
            ['user.guid'],
            name=op.f('fk_project_user_membership_enrollment_user_guid_user'),
        ),
        sa.PrimaryKeyConstraint(
            'project_guid',
            'user_guid',
            name=op.f('pk_project_user_membership_enrollment'),
        ),
    )
    op.create_table(
        'annotation',
        ...
        sa.ForeignKeyConstraint(
            ['asset_guid'],
            ['asset.guid'],
            name=op.f('fk_annotation_asset_guid_asset'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['encounter_guid'],
            ['encounter.guid'],
            name=op.f('fk_annotation_encounter_guid_encounter'),
            ondelete='CASCADE',
        ),
    ...
    with op.batch_alter_table('annotation', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_annotation_asset_guid'), ['asset_guid'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_annotation_encounter_guid'), ['encounter_guid'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['asset_guid'],
            ['asset.guid'],
            name=op.f('fk_sighting_assets_asset_guid_asset'),
        ),
        sa.ForeignKeyConstraint(
            ['sighting_guid'],
            ['sighting.guid'],
            name=op.f('fk_sighting_assets_sighting_guid_sighting'),
        ),
        sa.PrimaryKeyConstraint(
            'sighting_guid', 'asset_guid', name=op.f('pk_sighting_assets')
        ),
    )

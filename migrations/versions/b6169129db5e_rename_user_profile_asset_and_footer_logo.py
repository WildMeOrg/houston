"""Rename User profile_asset and footer_logo
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('footer_logo_fileupload_guid', app.extensions.GUID(), nullable=True))
        ...
        batch_op.create_foreign_key(batch_op.f('fk_user_footer_logo_fileupload_guid_file_upload'), 'file_upload', ['footer_logo_fileupload_guid'], ['guid'])
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(batch_op.f('fk_user_footer_logo_fileupload_guid_file_upload'), type_='foreignkey')
        ...
        batch_op.drop_column('footer_logo_fileupload_guid')

...
class Annotation(db.Model, HoustonModel, SageModel):
    ...
    # Accessors defined as nothing in the base class, need to be overridden in derived class as appropriate
    def get_owner_guid_str(self):
        return None

    def get_location_id_str(self):
        return None

    def get_taxonomy_guid_str(self):
        return None
...
class ScoutAnnotation(Annotation):
    ...
    task = db.relationship('MissionTask', back_populates='annotations')
    inExport = db.Column(db.Boolean, default=True, nullable=False)
